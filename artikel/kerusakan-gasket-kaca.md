---
article_id: GKG-08-04
title: "Gasket Kaca Mengeras, Menyusut, atau Keluar dari Posisi"
slug: "kerusakan-gasket-kaca"
...
date_modified: null
parent_topic: GKG-08
primary_intent: "Evaluate gasket deterioration"
reader_community: "Kacatempered.co.id"
reader_address: "Teman Kacatempered.co.id"
final_route: "/artikel/kerusakan-gasket-kaca.html"
...
# Gasket Kaca Mengeras, Menyusut, atau Keluar dari Posisi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Gasket Kaca Mengeras, Menyusut, atau Keluar dari Posisi”
...
- **Primary intent:** Evaluate gasket deterioration
...
- **Scope boundary:** Gasket condition only; glass breakage stays in GKG-04.
- **Final public route:** `/artikel/kerusakan-gasket-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Gasket Kaca Mengeras, Menyusut, atau Keluar dari Posisi**.
...
- `GKG-08-03` → `/artikel/drainase-frame-kaca-tersumbat.html` — Lubang Drainase Frame Kaca Tersumbat: Dampak dan Pemeriksaan
...
- `GKG-08-06` → `/artikel/kompatibilitas-sealant-glazing.html` — Kompatibilitas Sealant Baru dengan Residu dan Material Lama
...
- **Tie back to this article:** Keep the explanation specific to “Gasket Kaca Mengeras, Menyusut, atau Keluar dari Posisi”.
