---
article_id: GKG-05-05
title: "Alat Pembersih yang Berisiko Menggores Kaca atau Coating"
slug: "alat-cleaning-yang-berisiko-menggores-kaca"
...
date_modified: null
parent_topic: GKG-05
primary_intent: "Avoid abrasive tool damage"
reader_community: "Kacatempered.co.id"
reader_address: "Kawan Kacatempered.co.id"
final_route: "/artikel/alat-cleaning-yang-berisiko-menggores-kaca.html"
...
# Alat Pembersih yang Berisiko Menggores Kaca atau Coating

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Alat Pembersih yang Berisiko Menggores Kaca atau Coating”
...
- **Primary intent:** Avoid abrasive tool damage
...
- **Scope boundary:** Tool-risk guide; coated-glass identification belongs to GKG-02.
- **Final public route:** `/artikel/alat-cleaning-yang-berisiko-menggores-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Alat Pembersih yang Berisiko Menggores Kaca atau Coating**.
...
- `/pembersih-kaca-tangerang` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `GKG-05-06` → `/artikel/uji-area-kecil-restorasi-kaca-kusam.html` — Uji Area Kecil Sebelum Restorasi Kaca Kusam
...
- **Tie back to this article:** Keep the explanation specific to “Alat Pembersih yang Berisiko Menggores Kaca atau Coating”.
