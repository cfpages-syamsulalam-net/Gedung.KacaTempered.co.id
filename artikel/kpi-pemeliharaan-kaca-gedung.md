---
article_id: GKG-07-04
title: "KPI Pemeliharaan Kaca yang Lebih Berguna daripada Sekadar Bersih"
slug: "kpi-pemeliharaan-kaca-gedung"
description: "Set risk-based frequencies, checklists, records, and escalation triggers."
status: outline
publication_date: "2025-12-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GKG-07
primary_intent: "Measure maintenance outcomes"
reader_community: "Kacatempered.co.id"
reader_address: "Sobat Kacatempered.co.id"
final_route: "/artikel/kpi-pemeliharaan-kaca-gedung.html"
...
# KPI Pemeliharaan Kaca yang Lebih Berguna daripada Sekadar Bersih

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “KPI Pemeliharaan Kaca yang Lebih Berguna daripada Sekadar Bersih”
- **Reader and situation:** Set risk-based frequencies, checklists, records, and escalation triggers.
- **Reader outcome:** Set risk-based frequencies, checklists, records, and escalation triggers.
- **Primary intent:** Measure maintenance outcomes
...
- **Scope boundary:** Program metrics, not provider sales claims.
- **Final public route:** `/artikel/kpi-pemeliharaan-kaca-gedung.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **KPI Pemeliharaan Kaca yang Lebih Berguna daripada Sekadar Bersih**.
...
- `GKG-07-02` → `/artikel/checklist-berkala-kaca-gedung.html` — Checklist Bulanan, Semesteran, dan Tahunan Kaca Gedung
- `GKG-07-03` → `/artikel/trigger-eskalasi-temuan-kaca.html` — Trigger Eskalasi: Kapan Temuan Kaca Masuk Work Order Darurat?
- `GKG-07-05` → `/artikel/inventaris-kaca-dan-cmms.html` — Menghubungkan Inventaris Kaca dengan CMMS dan Riwayat Work Order
- `GKG-07-06` → `/artikel/review-tahunan-sistem-kaca.html` — Review Tahunan Kegagalan Kaca, Film, Sealant, dan Akses
...
- **Tie back to this article:** Keep the explanation specific to “KPI Pemeliharaan Kaca yang Lebih Berguna daripada Sekadar Bersih”.
