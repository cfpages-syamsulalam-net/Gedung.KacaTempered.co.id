---
article_id: GKG-07-03
title: "Trigger Eskalasi: Kapan Temuan Kaca Masuk Work Order Darurat?"
slug: "trigger-eskalasi-temuan-kaca"
...
date_modified: null
parent_topic: GKG-07
primary_intent: "Define escalation rules"
reader_community: "Kacatempered.co.id"
reader_address: "Teman Kacatempered.co.id"
final_route: "/artikel/trigger-eskalasi-temuan-kaca.html"
...
# Trigger Eskalasi: Kapan Temuan Kaca Masuk Work Order Darurat?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Trigger Eskalasi: Kapan Temuan Kaca Masuk Work Order Darurat?”
...
- **Primary intent:** Define escalation rules
...
- **Scope boundary:** Governance trigger, not emergency isolation steps owned by GKG-13.
- **Final public route:** `/artikel/trigger-eskalasi-temuan-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Trigger Eskalasi: Kapan Temuan Kaca Masuk Work Order Darurat?**.
...
- `GKG-07-01` → `/artikel/jadwal-preventive-maintenance-kaca.html` — Menyusun Jadwal Preventive Maintenance Kaca Berbasis Risiko
- `GKG-07-02` → `/artikel/checklist-berkala-kaca-gedung.html` — Checklist Bulanan, Semesteran, dan Tahunan Kaca Gedung
- `GKG-07-04` → `/artikel/kpi-pemeliharaan-kaca-gedung.html` — KPI Pemeliharaan Kaca yang Lebih Berguna daripada Sekadar Bersih
...
- **Tie back to this article:** Keep the explanation specific to “Trigger Eskalasi: Kapan Temuan Kaca Masuk Work Order Darurat?”.
