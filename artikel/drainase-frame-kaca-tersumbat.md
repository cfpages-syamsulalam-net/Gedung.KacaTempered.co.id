---
article_id: GKG-08-03
title: "Lubang Drainase Frame Kaca Tersumbat: Dampak dan Pemeriksaan"
slug: "drainase-frame-kaca-tersumbat"
description: "Diagnose and maintain the interfaces that keep glazing retained and weather-tight."
status: outline
publication_date: "2025-12-30"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GKG-08
primary_intent: "Diagnose blocked drainage paths"
reader_community: "Kacatempered.co.id"
reader_address: "Sobat Kacatempered.co.id"
final_route: "/artikel/drainase-frame-kaca-tersumbat.html"
...
# Lubang Drainase Frame Kaca Tersumbat: Dampak dan Pemeriksaan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Lubang Drainase Frame Kaca Tersumbat: Dampak dan Pemeriksaan”
- **Reader and situation:** Diagnose and maintain the interfaces that keep glazing retained and weather-tight.
- **Reader outcome:** Diagnose and maintain the interfaces that keep glazing retained and weather-tight.
- **Primary intent:** Diagnose blocked drainage paths
...
- **Scope boundary:** Drainage focus, not general façade-leak diagnosis.
- **Final public route:** `/artikel/drainase-frame-kaca-tersumbat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Lubang Drainase Frame Kaca Tersumbat: Dampak dan Pemeriksaan**.
...
- `GKG-08-01` → `/artikel/fungsi-komponen-interface-glazing.html` — Fungsi Structural Sealant, Weather Seal, Gasket, dan Setting Block
- `GKG-08-02` → `/artikel/gejala-kegagalan-sealant-fasad.html` — Gejala Sealant Fasad Kaca Gagal: Retak, Lepas, dan Hilang Adhesi
- `GKG-08-04` → `/artikel/kerusakan-gasket-kaca.html` — Gasket Kaca Mengeras, Menyusut, atau Keluar dari Posisi
- `GKG-08-05` → `/artikel/urutan-investigasi-kebocoran-kaca.html` — Kebocoran di Sekitar Kaca: Urutan Investigasi Tanpa Tebak-Tebakan
...
- **Tie back to this article:** Keep the explanation specific to “Lubang Drainase Frame Kaca Tersumbat: Dampak dan Pemeriksaan”.
